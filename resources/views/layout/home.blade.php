                            ...
                            <div class="flex-child flex-right nav-right hidden-sm hidden-xs">
                                <ul>
                                    ...
                                    <li class="nav-search-wrap style-2 hidden-sm hidden-xs">
                                        <a href="/product" class="nav-search search-trigger">
                                            <i class="fa fa-search"></i>
                                        </a>
                                    </li>
                                    <li class="nav-cart">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="widget footer-about-us">
                                <img src="/front/img/logo3.png" alt="" class="logo">
                                <p class="mb-30">Toko Duro is a character who does not exist in the real world, this character is the developer's imagination.</p>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <p>&copy; TokoDuro Since 2023</p>
                        </div>
                    </div>
                </div>
