...
<script>
    $(function() {
        ...
        // Isi form ubah pembayaran dengan data yang sudah ada
        $.get('/api/payments/' + id, function({ data }) {
            ...
            // Simpan status sebelumnya sebagai variabel global
        ...
        $('.form-Pembayaran').submit(function(e) {
            ...
            const newStatus = frmdata.get('status');

            // Memeriksa apakah status sebelumnya sudah 'DITERIMA'
            if (window.previousStatus === 'DITERIMA') {
                Swal.fire(
                    'Gagal!',
                    'Status sudah diubah sebelumnya dan tidak dapat diubah lagi.',
                    'error'
                );
            } else {
                // Lakukan permintaan untuk mengubah status
                $.ajax({
